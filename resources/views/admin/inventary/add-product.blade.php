    ...
    <section class="content container-fluid">
      <div class="box box-primary">
        <div class="box-header with-border">
          <div class="col-md-4">
            <h3 class="box-title"><i class="fa fa-pencil"></i> Registrar Producto</h3>
          </div>
          <div class="col-md-8">
          ...
          <div class="box-body">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" name="precio_lista" id="priceList" placeholder="Precio Lista" onchange="priceSales();" value="{{ old('precio_lista') }}" class="form-control" step=".01">
              </div>
              <div class="form-group">
                <label for="cost">Costo:</label>
                <input type="number" name="costo" id="cost" placeholder="Costo" onchange="priceSales();" value="{{ old('costo') }}" class="form-control" step=".01">
              </div>
