...
@section('content')
    ...
    <section class="content container-fluid">
      ...
      <div class="box box-primary">
        ...
        {!! Form::model($product, ['method' => 'POST','route' => ['producto.update', $product->id], 'role' => 'form']) !!}
          {{ csrf_field() }}
          <div class="box-body">
            <div class="col-md-4">
              ...
              <div class="form-group {{ $errors->has('proveedor-view') ? 'has-error' : '' }}">
                ...
                <input type="text" name="proveedor-view" id="proveedor" value="{{$product->supplier->nombre_empresa}}" class="form-control" readonly>
            ...
            <div class="col-md-4">
              <div class="form-group {{ $errors->has('fecha_entrada') ? 'has-error' : '' }}">
                ...
                <div class="input-group">
                  ...
                  <input type="text" value="{{$product->checkin}}" name="fecha_entrada" class="form-control" id="datepickerProduct" placeholder="dd/mm/aaaa">
                </div>
            ...
            <div class="col-md-4">
              <div class="form-group {{ $errors->has('precio_lista') ? 'has-error' : '' }}">
                ...
                <input type="number" name="precio_lista" id="priceList" placeholder="Precio Lista" onchange="priceSales();" value="{{$product->priceList}}" class="form-control" step=".01">
                {!! $errors->first('precio_lista','<span class="help-block">:message</span>')!!}
              </div>
              <div class="form-group {{ $errors->has('costo') ? 'has-error' : '' }}">
                <label for="cost">Costo:</label>
                <input type="number" name="costo" id="cost" placeholder="Costo" onchange="priceSales();" value="{{$product->cost}}" class="form-control" step=".01">
